...
static void TurnOnDacPower(void)
{
    ...
    Ana_Set_Reg(AFE_UL_DL_CON0 , 0x0001, 0x0001); //[0] afe enable
...
static bool TurnOnADcPowerACC(int ADCType, bool enable)
{
    ...
    else
    {
        ...
        if (GetAdcStatus() == false)
        {
            ...
            if (GetDLStatus() == false)
            {
                Ana_Set_Reg(AFE_UL_DL_CON0, 0x0000, 0x0001);   //afe disable
...
static bool TurnOnADcPowerDmic(int ADCType, bool enable)
{
    ...
    if (enable)
    {
        ...
        if (GetAdcStatus() == false)
        {
            ...
            {
                Ana_Set_Reg(AFE_UL_DL_CON0 , 0x8001, 0x8001); //bit15: UL L/R swap
            }
            else
            {
                Ana_Set_Reg(AFE_UL_DL_CON0 , 0x0001, 0x8001); //[0] afe enable
            }
