...
static int sdcardfs_show_options(struct seq_file *m, struct dentry *root)
{
	...
	seq_printf(m, ",write_gid=%u", opts->write_gid);
	seq_printf(m, ",derive=%u", opts->derive);
	seq_printf(m, ",split_perms=%u", opts->split_perms);
	seq_printf(m, ",lower_fs=%u", opts->lower_fs);
